...
" color groups
highlight Projects ctermfg=DarkRed
highlight Context ctermfg=Blue
highlight PriA ctermfg=Red
highlight PriB ctermfg=Magenta
highlight PriC ctermfg=Green
highlight Date ctermfg=DarkGray
highlight Foldmarker ctermfg=Red

" Other priority colours might be defined by the user
highlight  default  link  TodoDone       Comment
highlight  default  link  TodoPriorityA  PriA
highlight  default  link  TodoPriorityB  PriB
highlight  default  link  TodoPriorityC  PriC
highlight  default  link  TodoDate       Date
highlight  default  link  TodoProject    Projects
